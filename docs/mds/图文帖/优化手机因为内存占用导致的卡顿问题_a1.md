...
**脚本:**
  1. [kill.sh](res/a1-kill.sh)  停止软件（**`当前的列表有问题，请使用大佬研究或自行研究列表，取消部分系统app`**）
  2. [scan_swap.sh](res/a1-scan_swap.sh)  扫描swap
  3. [adb5555.sh](res/a1-adb5555.sh)  开启adb
  4. [adb_stop.sh](res/a1-adb_stop.sh)  关闭adb
...
1. 使用 [kill.sh](res/a1-kill.sh) 脚本（**`当前的列表有问题，请使用大佬研究或自行研究列表，取消部分系统app`**）
