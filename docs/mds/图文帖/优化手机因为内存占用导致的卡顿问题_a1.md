...
## 相关资源
1. 脚本: [kill.sh](res/a1-kill.sh)
2. 脚本: [scan_swap.sh](res/a1-scan_swap.sh)
3. 网页: [opts_swap.html](res/a1-opts_swap.html)
...
1. 下载对应的通用脚本 [kill.sh](res/a1-kill.sh)
...
### 二、构建kill.sh脚本
1. 长按 `opts_swap.html` 使用浏览器打开该网页文件 (可以[直接点击访](/docs/mds/图文帖/res/a1-opts_swap.html)问这个页面) 
...
* [运行结果图](res/a1-7.jpg) ![alt text](res/a1-7.jpg)
