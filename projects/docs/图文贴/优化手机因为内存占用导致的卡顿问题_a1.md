...
**蓝奏云链接:** https://wwbqf.lanzouu.com/ijCFa3ijij8b  

**脚本:**
  1. [kill.sh](res/a1-kill.sh){download} 停止软件（**`当前的列表有问题，请使用大佬研究或自行研究列表，取消部分系统app`**）
  2. [scan_swap.sh](res/a1-scan_swap.sh){download} 扫描swap
  3. [adb5555.sh](res/a1-adb5555.sh){download} 开启adb
  4. [adb_stop.sh](res/a1-adb_stop.sh){download} 关闭adb

**网页:**
  1. [opts_swap.html](res/a1-opts_swap.html){target="_blank"}

# 快速操作 - （**`当前的列表有问题，请使用大佬研究或自行研究列表，取消部分系统app`**）
> 需求: `拥有adb权限`  

1. 使用 [kill.sh](res/a1-kill.sh){download} 脚本（**`当前的列表有问题，请使用大佬研究或自行研究列表，取消部分系统app`**）
...
### 二、构建kill.sh脚本
1. 长按 `opts_swap.html` 使用浏览器打开该网页文件 (可以 [直接点击](res/a1-opts_swap.html) 访问这个页面) 
